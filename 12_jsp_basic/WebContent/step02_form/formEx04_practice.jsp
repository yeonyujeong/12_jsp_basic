	...
	<form method="post" action="formEx04Pro.jsp" onsubmit="return formValidationCheck()">
		<fieldset>
			...
			<p>
  			...
  			<p><label for="name"><span style="color:red">*</span>연락처 : </label><input type="text"  id="contact" name="contact" autofocus></p>
  			<p><label for="name"><span style="color:red">*</span>이메일 : </label>
  			...
  			<p>
  				...
  				<select name="modelName">
  					...
  					<option value="Yoga">Yoga5세대</option>
